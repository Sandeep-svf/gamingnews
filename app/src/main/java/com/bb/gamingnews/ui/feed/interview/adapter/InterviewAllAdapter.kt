package com.bb.gamingnews.ui.feed.interview.adapter
...
class InterviewAllAdapter(var context: Context,
                          var callback:Callback,
                          var listTexts: List<GetAllInterviewResponceModel.Data>)
    : RecyclerView.Adapter<InterviewAllAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setData(position: Int) {
            Glide.with(context).load(listTexts[position].videoThumbnailUrl).placeholder(R.drawable.space_transparent).into(itemView.imgInterview)
